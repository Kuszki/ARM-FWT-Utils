  ...
  arm_dwt_instance_f32* pDWTInstance)
{
     ...
     else if ((pDWTInstance->pHighFilter == NULL) || (pDWTInstance->pLowFilter == NULL) || (pDWTInstance->pInternalBuffer == NULL) || (pDWTOut->pACoeffs == NULL) || (pDWTOut->pDCoeffs == NULL))
     {
          res = DWT_STATUS_INVALID_PARAMETER;
     }
     else
...
{
     arm_dwt_status res = DWT_STATUS_ERROR;
     if ((pHighFilter == NULL) || (pLowFilter == NULL) || (pInternalBuffer == NULL) || (pDWTInstance == NULL))
     {
          res = DWT_STATUS_INVALID_PARAMETER;
     }
     else
  ...
  arm_dwt_out_f32* pDWTOut)
{
     ...
     else if ((pDWTInstance->pHighFilter == NULL) || (pDWTInstance->pLowFilter == NULL) || (pDWTInstance->pInternalBuffer == NULL) || (arm_dwt_check_f32(pDWTInstance, blockSize) != DWT_STATUS_SUCCESS))
     {
          res = DWT_STATUS_INVALID_PARAMETER;
     }
     else
